...
struct BMP {
	...
	void fill_region(uint32_t x0, uint32_t y0, uint32_t w, uint32_t h, uint8_t B, uint8_t G, uint8_t R, uint8_t A = 255) {
	...
	void set_pixel(uint32_t x0, uint32_t y0, uint8_t B, uint8_t G, uint8_t R, uint8_t A = 255) {
	...
	void set_pixel(uint32_t x0, uint32_t y0, uint8_t A = 0) {
		set_pixel(x0, y0, 0, 0, 0, A);
	}

	void draw_rectangle(uint32_t x0, uint32_t y0, uint32_t w, uint32_t h, uint8_t line_w, uint8_t B, uint8_t G, uint8_t R, uint8_t A = 255) {
		if (x0 + w > (uint32_t)bmp_info_header.width || y0 + h > (uint32_t)bmp_info_header.height) {
